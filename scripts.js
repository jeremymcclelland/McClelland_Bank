...
var login = function() {
  ...
  /* Write code here */
  promptReplace('userName', "Please enter user name!");
...
var changeUserAddress = function() {
  /* Write code here */
    promptReplace('userAddress', "Please enter your new address");

}
var changeAccountNumber = function() {
  /* Write code here */
    promptReplace('accountNumber', "Please enter your new account number");
}
var changeAccountOpenDate = function() {
  /* Write code here */
    promptReplace('accountOpenDate', "Please enter your account open date");
}


function promptReplace(id, promptMessage){
  var tempPrompt = prompt(promptMessage);
  document.getElementById(id).innerHTML = tempPrompt;
}
...
var accountBalance = document.getElementById('balance').innerHTML;
accountBalance = parseFloat(accountBalance);

var newBalance = accountBalance + depositAmount;
...
var newBalance = accountBalance - withdrawAmount;
document.getElementById('balance').innerHTML = newBalance.toFixed(2);
  /* Write code here */
...
var forward = function() {
  ...
  /* Write code here */
  var getBalance = document.getElementById('balance').innerHTML;
  getBalance = parseFloat(getBalance)
  var interestRate = 1.03;
  var newBalance = getBalance * interestRate;
  document.getElementById('balance').innerHTML = newBalance.toFixed(2);
}
...
var back = function() {
  ...
  getBalance = parseFloat(getBalance)
  var interestRate = .03;
  var newBalance = getBalance - (getBalance * interestRate);
  document.getElementById('balance').innerHTML = newBalance.toFixed(2);
